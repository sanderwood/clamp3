...
if __name__ == '__main__':
    ...
    # Output the number of numpy arrays loaded from each folder
    print(f"Loaded {len(test_npy)} numpy arrays from '{test}'")
    print(f"Loaded {len(ref_npy)} numpy arrays from '{reference}'")
